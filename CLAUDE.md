...
| Table | Purpose |
|-------|---------|
| `cases` | Litigation case records (id, entity, docket_number, case_name, case_type, court_name, status, nature_of_suit, cause_of_action, demand, judge, plaintiffs, defendants, attorneys, complaint_text, complaint_summary, blaw_url, filed, updated, date_logged, case_viability, viability_reasoning) |
...
| `preference_signals` | Extracted signals: dimension, entity, score per narrative (source: 'narrative' or 'reaction') |
...
| `user_case_scores` | Per-user per-case relevance scores: score, reasoning, source, stale, scored_at |
